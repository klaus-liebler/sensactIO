...
class I2C{
    ...
    static esp_err_t WriteReg(const i2c_port_t port, uint8_t address7bit, uint8_t reg_addr, const uint8_t *reg_data, size_t len);
    static esp_err_t Write(const i2c_port_t port, uint8_t address7bit, const uint8_t *data, size_t len);
